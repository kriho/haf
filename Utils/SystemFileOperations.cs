...
namespace HAF {
  public static partial class Utils {
    ...
    private class SystemFileOperations {
    ...
    public static Task MoveFile(string sourceFilePath, string destinationFilePath) {
      return Task.Run(() => {
        var op = new SystemFileOperations() {
          wFunc = SystemFileOperations.FO_Func.FO_MOVE,
          pFrom = sourceFilePath,
          pTo = destinationFilePath,
        };
        op.Execute();
      });
    }

    public static Task CopyFile(string sourceFilePath, string destinationFilePath) {
      return Task.Run(() => {
        var op = new SystemFileOperations() {
          wFunc = SystemFileOperations.FO_Func.FO_COPY,
          pFrom = sourceFilePath,
          pTo = destinationFilePath,
        };
        op.Execute();
    ...
    public static Task RenameFile(string sourceFilePath, string destinationFilePath) {
      return Task.Run(() => {
        var op = new SystemFileOperations() {
          wFunc = SystemFileOperations.FO_Func.FO_RENAME,
          pFrom = sourceFilePath,
          pTo = destinationFilePath,
        };
        op.Execute();
    ...
    public static Task DeleteFile(string filePath) {
      return Task.Run(() => {
        var op = new SystemFileOperations() {
          wFunc = SystemFileOperations.FO_Func.FO_DELETE,
          pFrom = filePath,
        };
        op.Execute();
      });
